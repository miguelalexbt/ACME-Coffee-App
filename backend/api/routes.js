...
itemRouter.get('/populate', async (req, res) => {
    ...
    await new Item({ name: 'Blueberry Muffin', type: 'pastry', price: 2.00 }).save();
    await new Item({ name: 'Chocolate Muffin', type: 'pastry', price: 2.00 }).save();
    await new Item({ name: 'Eggs and Bacon', type: 'breakfast', price: 5.99 }).save();
    await new Item({ name: 'French Toast', type: 'breakfast', price: 4.99 }).save();
    await new Item({ name: 'Bagel', type: 'breakfast', price: 2.30 }).save();
    await new Item({ name: 'Ice Tea', type: 'drink', price: 1.50 }).save();
    await new Item({ name: 'Orange Juice', type: 'drink', price: 1.99 }).save();
